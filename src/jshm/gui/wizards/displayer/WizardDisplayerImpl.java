// I've copied the default WizardDisplayerImpl from the SwingLabs
// sources so that I could display an entire panel to indicate
// progress instead of a tiny little thing in the left panel
...
public class WizardDisplayerImpl extends WizardDisplayer
{
     ...
     * @param comp
     */
    private void setCurrentPanel(JComponent comp) {
    ...
    protected NavProgress createProgressDisplay (boolean isUseBusy)
    {
    ...
    void handleDeferredWizardResult(final DeferredWizardResult r, final boolean inSummary)
    {
        ...
        // here's where i customize the progress display
        NavProgress navProg = createProgressDisplay(r.isUseBusy());
        progress = navProg;
        setCurrentPanel(navProg.getProgPanel());
